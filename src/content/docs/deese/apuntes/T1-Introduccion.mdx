...
![Thank God not everything is software](@assets/thank-god-not-everything-is-software.jpg)
...
![Estático vs Dinámico](@assets/static-vs-dynamic.jpg)

## 2. Ingeniería del Software

![How to write good code](@assets/how-to-write-good-code.jpg)
...
![Programa en POO](@assets/Programa-en-POO.png)
  ...
  entries={[
    {
      ...
      description:
        "© 2025 licensed under Creative Commons Attribution-NonCommercial 4.0 International",
    },
  ]}
/>
