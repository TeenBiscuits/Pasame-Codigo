...
### Modelado
- Un modelo simplifica la realidad para entender sistemas complejos.
...
- Los diseños de software son dinámicos y evolucionan constantemente, a diferencia de las limitaciones físicas en arquitectura.
