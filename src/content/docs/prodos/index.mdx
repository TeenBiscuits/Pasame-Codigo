...
## Apuntes :badge[Descontinuados]{variant=caution}

:::note

Estos apuntes están descontinuados, se mantienen aquí por cuestiones de archivo. Recomiendo encarecidamente consultar [los apuntes de Dani Callero](https://wiki.danicallero.es/Universidad/Programación-2/)
...
<ShowcaseImage
  entries={[
    {
      thumbnail: import('@assets/prodos/repos/Daniel.png'),
      href: 'https://wiki.danicallero.es/Universidad/Programación-2/',
      title: 'Wiki de Dani Callero',
      description: 'Apuntes de Programación 2 de Dani Callero',
    },
    {
      thumbnail: import('@assets/prodos/repos/PRO2.png'),
